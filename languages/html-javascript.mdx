            ...
            try {
                ...
                if (resultado.success && resultado.charge) {
                    ...
                    resultDiv.innerHTML = `
                        ...
                        <div class="qr-code">
                            <h3>QR Code PIX</h3>
                            <img src="${charge.qrCode.image}" alt="QR Code PIX">
                        </div>
                        
                        <p><strong>BR Code:</strong></p>
                        <textarea readonly style="width: 100%; height: 60px; font-family: monospace;">${charge.pixCode}</textarea>
                        
                        <p><strong>Link de Pagamento:</strong></p>
                        <a href="${charge.publicPaymentUrl}" target="_blank">Ver Página de Pagamento</a>
                    `;
                } else {
...
async function criarPagamento(apiToken, chargeId, valor, comentario = null) {
    ...
    try {
        ...
        if (resultado.success && resultado.charge) {
            ...
            console.log('🔲 QR Code (base64):', charge.qrCode.image.substring(0, 50) + '...');
