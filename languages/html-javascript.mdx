...
description: 'Implementação completa da API FlowPay em JavaScript puro (HTML estático) com exemplos práticos'
icon: 'html'
---

## Implementação HTML & JavaScript

Guia completo para integrar a API FlowPay em páginas HTML estáticas usando JavaScript puro (vanilla JS) ou Fetch API.
...
class FlowPayAPI {
    constructor(apiToken) {
        this.baseURL = 'https://www.flowapplications.com.br/api/v1';
        this.apiToken = apiToken || '';
        
        if (!this.apiToken) {
            console.error('⚠️ Token de API não fornecido');
        }
    }
...
<body>
    ...
    <form id="paymentForm">
        ...
        <div class="form-group">
            <label for="correlationID">ID de Correlação:</label>
