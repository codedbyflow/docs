---
title: 'Go'
description: 'Implementação completa da API FlowPay em Go (Golang) com exemplos práticos'
icon: 'go'
---

## Implementação Go

Guia completo para integrar a API FlowPay em suas aplicações Go usando net/http ou bibliotecas HTTP modernas.
...
const BaseURL = "https://flowapplications.com.br/api/v1"
...
func NewClientResty(apiToken string) *ClientResty {
    ...
    client := resty.New()
    client.SetBaseURL("https://flowapplications.com.br/api/v1")
