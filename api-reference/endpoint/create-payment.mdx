...
<RequestExample url="https://www.flowapplications.com.br/api/v1/payment/create" method="POST" auth="bearer" authParam="seu_token_aqui">
...
```bash
curl -X POST https://www.flowapplications.com.br/api/v1/payment/create \
