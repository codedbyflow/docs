...
<RequestExample url="https://www.flowapplications.com.br/api/v1/payment/verify/{correlationID}" method="GET" auth="bearer" authParam="seu_token_aqui" pathParams={{"correlationID":"pedido-123"}}>
...
const API_BASE_URL = 'https://www.flowapplications.com.br/api/v1';
...
API_BASE_URL = 'https://www.flowapplications.com.br/api/v1'
...
```bash
curl -X GET https://www.flowapplications.com.br/api/v1/payment/verify/pagamento-1234567890 \
...
$apiBaseUrl = 'https://www.flowapplications.com.br/api/v1';
